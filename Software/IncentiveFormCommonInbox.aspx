<%@ Page Title="DataEntry" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="IncentiveFormCommonInbox.aspx.cs" Inherits="ERecs.IncentiveFormCommonInbox" EnableEventValidation="false" %>
        ...
        <asp:UpdatePanel ID="updatePanel3" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <div class="form-group row">
                    ...
                    <div class="col-sm-2">
                        <asp:TextBox ID="txtIID" placeholder="Incentive ID" runat="server" CssClass="form-control correct value" Text="" ReadOnly="true"></asp:TextBox>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="txtUSysCode" class="col-sm-2 col-form-label">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <asp:TextBox ID="txtBase" placeholder="Ship/Establishment" runat="server" CssClass="form-control correct value" Text=""></asp:TextBox>
                    </div>
                    <asp:Label ID="lblMBaseCode" class="col-sm-2 col-form-label" runat="server" Text=""></asp:Label>
                </div>
                   <div class="form-group row">
                    <label for="txtReason" class="col-sm-2 col-form-label">Remarks :</label>
                    <div class="col-sm-4">
                        <asp:TextBox ID="txtReason" placeholder="Reject reason" runat="server" CssClass="form-control correct value" Text="" BorderColor="#CC3300" ForeColor="#FF0066"></asp:TextBox>
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-sm-1">
                        <asp:Button ID="btnForward" runat="server" Text="Forward" CssClass="btn btn-primary" OnClick="btnForward_Click" Enabled="false" />
                    </div>
                    <div class="col-sm-2">
                        <asp:Button ID="BtnReject" runat="server" Text="Reject" CssClass="btn btn-primary" OnClick="BtnReject_Click" Enabled="false" />
                    </div>
                </div>
            </ContentTemplate>
        </asp:UpdatePanel>
         ...
         <div class="card">
            ...
            <div class="card-header" role="tab" id="headingTwo3">
                <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="#collapseTwo3"
                    aria-expanded="true" aria-controls="collapseTwo2">
                    <h5 class="mb-0">Rejected  <i class="fas fa-angle-double-right  rotate-icon"></i>
                    </h5>
                </a>
            </div>
                        ...
                        <ContentTemplate>
                            <fieldset>
                                <div class="form-group row">
                                    ...
                                    <asp:GridView ID="GVRejected" runat="server" class="table table-dark table-striped" Width="1105px" >
