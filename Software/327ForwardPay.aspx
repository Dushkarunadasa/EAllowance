<%@ Page Title="Allowance Transactions" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="327ForwardPay.aspx.cs" Inherits="ERecs.ForwardPay" %>
...
<asp:Content ID="Main" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                            ...
                            <fieldset>
                                <div class="form-group row">
                                    <asp:GridView ID="GvTransPending" runat="server" class="table table-dark table-striped" Width="1285px" OnRowCommand="GvTransPending_RowCommand">
                                        ...
                                        <Columns>
                                            <asp:ButtonField ButtonType="Button" ControlStyle-CssClass="btn btn-danger" CommandName="rEdit" HeaderText="Edit" ShowHeader="True" Text="Edit" />
                                        </Columns>
                                        <Columns>
                                            <asp:ButtonField ButtonType="Button" ControlStyle-CssClass="btn btn-success" CommandName="Process" HeaderText="Process" ShowHeader="True" Text="Process" />
                                        </Columns>
                                        <Columns>
                                        ...
                                        <Columns>
                                            <asp:TemplateField HeaderText="Edit Reason">
                                                <ItemTemplate>
    ...
    <br />
     <p>327 Allowances details as per the BOI</p>
    <br />
    <div class="form-group row">
        <asp:UpdatePanel ID="updatePanel4" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <asp:GridView ID="GvSubjectItems" runat="server" AutoPostBack="true" class="table table-dark table-striped" Width="1285px" OnRowCommand="GvSubjectItems_RowCommand">
    ...
    <br />
    <p>Paid 327 Allowances details as per the Payroll System</p>
    <br />
    <div class="form-group row">
