<%@ Page Title="DataEntry" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="DataEntry.aspx.cs" Inherits="ERecs.DataEntry" EnableEventValidation="false" %>
                        ...
                        <ContentTemplate>
                            <fieldset>
                                ...
                                <div class="form-group row">
                                    ...
                                    <label for="amt" class="col-sm-2 col-form-label">Effect Date</label>
                                    <div class="col-sm-2">

                                        <asp:TextBox ID="txtEffectDt" runat="server" TextMode="Date" CssClass="form-control" MaxLength="10"></asp:TextBox>
