<%@ Page Title="Forward" EnableEventValidation="false"  Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="TransactionsPay.aspx.cs" Inherits="ERecs.TransactionsPay" %>

<asp:Content ID="Main" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:ScriptManager ID="ScriptManager1" runat="server" EnablePageMethods="True"></asp:ScriptManager>
    <h5>Allowances History...</h5>
        ...
        <div class="card">
            ...
            <div class="card-header" role="tab" id="headingOne1">
                <a data-toggle="collapse" data-parent="#accordionEx" href="#collapseOne1" aria-expanded="false"
                    ...
                    <h5 class="mb-0 ">Confirmed Allowances Lists <i class="fas fa-angle-double-right  rotate-icon"></i>
                    </h5>
                </a>
            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <asp:GridView ID="GVTransConfirmed" AutoPostBack="true" class="table table-dark table-striped" runat="server" Width="1105px" OnRowCommand="GVTransConfirmed_RowCommand">
                                <Columns>
                                    ...
                                    <asp:ButtonField ButtonType="Button" CommandName="ScannedDocs" HeaderText="Scanned" ShowHeader="True" Text="ScannedDocs" />
