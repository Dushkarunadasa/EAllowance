...
<asp:Content ID="Main" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Wizard ID="Wizard1" runat="server" HeaderText="Initial Registration" HeaderStyle-Font-Size="Larger" HeaderStyle-ForeColor="Crimson" OnFinishButtonClick="Wizard1_FinishButtonClick" OnNextButtonClick="Wizard1_NextButtonClick" OnPreviousButtonClick="Wizard1_PreviousButtonClick" Width="630px">
        <WizardSteps>
            <asp:WizardStep ID="WizadStep1" runat="server" Title="Subject Clerk Details">

                <p class="text-info">Relavent subject clerk details: </p>
            ...
            <asp:WizardStep ID="WizardStep2" runat="server" Title="Secretary Details">
            ...
            <asp:WizardStep ID="WizardStep1" runat="server" Title="Authorized Officer">
