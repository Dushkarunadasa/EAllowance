<%@ Page Title="327Adjustment" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="327Adjustment.aspx.cs" Inherits="ERecs.Adjustment" EnableEventValidation="false" %>
            ...
            <ContentTemplate>
                <div class="form-group row">
                    <div class="form-group col-2">
                        ...
                        <div class="form-group row">
                            <asp:Label ID="Label1" class="col-form-label" runat="server" Text="Description"></asp:Label>
                        </div>
                    ...
                    <div class="form-group col-4">
                        ...
                        <div class="form-group row">
                            <asp:TextBox ID="txtDescription" placeholder="Description" runat="server" CssClass="form-control correct value" Text=""></asp:TextBox>
                        </div>
        ...
        <div class="card">
            ...
            <div class="card-header" role="tab" id="headingOne1">
                <a data-toggle="collapse" data-parent="#accordionEx" href="#collapseOne1" aria-expanded="false"
                    ...
                    <h5 class="mb-0 ">Upload BOI Report <i class="fas fa-angle-double-right  rotate-icon"></i>
                    </h5>
                </a>
            </div>
            ...
            <div id="collapseOne1" class="collapse show" role="tabpanel" aria-labelledby="headingOne1"
                ...
                <div class="card-body p-3 mb-2 bg-secondary text-white">
                    <fieldset>
                        ...
                        <div class="form-group row">
                            <p style="color: red;">
                                ‍මෙම පද්ධතියට එකකට වඩා ස්කෑන් ‍‍ලිපිගොණු උඩුගත කිරීම සදහා අදාළ ලිපිගොණු සියල්ල Zip ලිපිගොණුවක් ලෙස සකස් කර උඩුගත කිරීම කල හැකිය.
                            </p>
                        </div>
